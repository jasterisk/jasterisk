...
import com.github.jasterisk.invoker.auth.HttpBasicAuth;
import com.github.jasterisk.invoker.auth.ApiKeyAuth;
import com.github.jasterisk.invoker.auth.OAuth;
import com.github.jasterisk.invoker.auth.OAuth.AccessTokenListener;
import com.github.jasterisk.invoker.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://localhost:8088/ari";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
